...
plot(data1$Date, final_res, type = "l", xlab = "Time", ylab = "Residuals", cex.lab = 1.5)
abline(h = 0, col = "red", lwd = 2)
dev.off()

png("images/acf.png", width = 600, height = 600)
acf(final_res, cex.lab = 1.5, main = "")
dev.off()

png("images/hist.png", width = 600, height = 600)
hist(final_res, probability = TRUE, breaks = 30, col = "lightblue", xlab = "Residuals", main = "", cex.lab = 1.5)
...
qqnorm(final_res, main = "", cex.lab = 1.5)
...
par(mfrow = c(2, 2))
plot(qgam_model, select = 2, shade = TRUE, col = "black", ylab = "Effect", xlab = "Time of year", cex.lab = 2)
plot(qgam_model, select = 3, shade = TRUE, col = "red", shade.col = "pink", ylab = "Effect", xlab = "Temperature", , cex.lab = 2)
plot(qgam_model, select = 4, shade = TRUE, col = "blue", shade.col = "lightblue", ylab = "Effect", xlab = "Lagged load on Monday", , cex.lab = 2)
plot(qgam_model, select = 13, shade = TRUE, col = "orange", shade.col = "yellow", ylab = "Effect", xlab = "Lagged net demand", , cex.lab = 2)
dev.off()
...
vis.gam(qgam_model, view = c("Nebulosity", "Nebulosity_weighted"), theta = 30, ticktype = "detailed",
        color = "topo", cex.lab = 2)
dev.off()

png("images/wind_iterac.png", width = 600, height = 600)
vis.gam(qgam_model, view = c("Wind", "Wind_weighted"), theta = 30, ticktype = "detailed", color = "gray", , cex.lab = 2)
dev.off()

png("images/stemp_iterac.png", width = 600, height = 600)
vis.gam(qgam_model, view = c("Temp_s99", "Temp_s95_min"), theta = 30, ticktype = "detailed", color = "terrain", , cex.lab = 2)
dev.off()

png("images/stempmin_iterac.png", width = 600, height = 600)
vis.gam(qgam_model, view = c("Temp_s99", "Temp_s95"), theta = 30, ticktype = "detailed", color = "heat", , cex.lab = 2)
dev.off()
